...
대상폴더 미지정 시 현재 폴더에서 모든 .html 파일 처리
"""
import os, sys, re
from pathlib import Path

OLD_NAV = '<nav class="header-nav" style="margin-left:0;">\n<a href="/seoul/">서울</a><a href="/incheon/">인천</a><a href="/gyeonggi/">경기</a><a href="/busan/">부산</a><a href="/daegu/">대구</a><a href="/daejeon/">대전</a><a href="/gwangju/">광주</a><a href="/ulsan/">울산</a><a href="/sejong/">세종</a><a href="/gangwon/">강원</a><a href="/gyeongnam/">경남</a>\n</nav>'
...
print(f"⚠️  nav 없음 (구버전): {not_found}개")
print(f"❌ 오류: {skipped}개")
